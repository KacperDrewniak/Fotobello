...
function createMergedTypes(typeCandidates, mergeTypes) {
    ...
    Object.keys(typeCandidates).forEach(function (typeName) {
        if (typeCandidates[typeName][0].type instanceof graphql_1.GraphQLObjectType) {
            var mergedTypeCandidates = typeCandidates[typeName]
                .filter(function (typeCandidate) {
                return typeCandidate.subschema &&
            ...
            if (mergeTypes === true ||
                ...
                var subschemas_1 = [];
                var requiredSelections_1 = [utils_1.parseSelectionSet("{ __typename }").selections[0]];
                ...
                mergedTypeCandidates.forEach(function (typeCandidate) {
                    ...
                    Object.keys(fieldMap).forEach(function (fieldName) {
                        fields_1[fieldName] = fields_1[fieldName] || [];
                    ...
                    if (!mergedTypeConfig.resolve) {
                        mergedTypeConfig.resolve = function (originalResult, context, info, subschema, selectionSet) { return delegateToSchema_1.default({
                            schema: subschema,
                            operation: 'query',
                ...
                subschemas_1.forEach(function (subschema) {
                    ...
                    subschemas_1.filter(function (s) { return s !== subschema; }).forEach(function (s) {
                        var selectionSet = selectionSets_1.get(s);
                        if (selectionSet && utils_1.typeContainsSelectionSet(type, selectionSet)) {
