...
function createRequestFromInfo(_a) {
    ...
    return createRequest(info.schema, info.fragments, info.operation.variableDefinitions, info.variableValues, schema, operation, fieldName, args, selectionSet, selectionSet ? undefined : (fieldNodes ? fieldNodes : info.fieldNodes));
}
...
function createRequest(sourceSchema, fragments, variableDefinitions, variableValues, targetSchemaOrSchemaConfig, targetOperation, targetField, args, selectionSet, fieldNodes) {
    ...
    if (!selectionSet && fieldNodes) {
        var selections = fieldNodes.reduce(function (acc, fieldNode) { return fieldNode.selectionSet ?
