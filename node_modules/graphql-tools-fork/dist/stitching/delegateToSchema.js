...
var AddReplacementFragments_1 = require("../transforms/AddReplacementFragments");
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    if (args) {
                        transforms.push(new AddArgumentsAsVariables_1.default(targetSchema, args));
                    }
