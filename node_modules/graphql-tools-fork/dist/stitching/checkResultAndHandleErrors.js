...
function handleResult(result, errors, subschemas, context, info) {
    ...
    if (graphql_1.isLeafType(type)) {
        ...
        var object = handleObject(result, errors, subschemas);
...
function handleObject(object, errors, subschemas) {
...
function handleListMember(type, listMember, index, errors, subschemas, context, info) {
    ...
    if (graphql_1.isLeafType(type)) {
        ...
        var object = handleObject(listMember, errors, subschemas);
        return mergeFields(type, object, subschemas, context, info);
    }
    else if (graphql_1.isListType(type)) {
...
function mergeFields(type, object, subschemas, context, info) {
    return __awaiter(this, void 0, void 0, function () {
        var typeName_1, initialSchemas, remainingSubschemas, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!info.mergeInfo) return [3 /*break*/, 2];
                    if (graphql_1.isAbstractType(type)) {
                        typeName_1 = info.schema.getTypeMap()[resolveFromParentTypename_1.default(object)].name;
                    }
                    else {
                        typeName_1 = type.name;
                    }
                    initialSchemas = info.mergeInfo.mergedTypes[typeName_1] &&
                        info.mergeInfo.mergedTypes[typeName_1].subschemas;
                    ...
                    return [4 /*yield*/, Promise.all(remainingSubschemas.map(function (subschema) {
                            var mergedTypeResolver = subschema.mergedTypeConfigs[typeName_1].mergedTypeResolver;
                ...
                case 1:
                    results = _a.sent();
                    results.forEach(function (r) { return Object.assign(object, r); });
                    _a.label = 2;
