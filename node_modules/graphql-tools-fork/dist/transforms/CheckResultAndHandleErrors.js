...
var CheckResultAndHandleErrors = /** @class */ (function () {
    ...
    CheckResultAndHandleErrors.prototype.transformResult = function (result) {
        return checkResultAndHandleErrors_1.checkResultAndHandleErrors(result, this.context, this.info, this.fieldName, this.subschema, this.returnType, this.typeMerge);
    };
