...
var transformInputValue_1 = require("../utils/transformInputValue");
            ...
            if (selection.kind === graphql_1.Kind.FIELD) {
                ...
                field.args.forEach(function (argument) {
                    if (argument.name in args) {
                        ...
                        newVariables[variableName] = transformInputValue_1.serializeInputValue(argument.type, args[argument.name]);
                    }
                });
