...
const get = require('lodash/get'); // This is used to associate the existing node (of user-specified type) with the
...
exports.createResolvers = ({
  ...
  const resolvers = {
    [nodeType]: {
      [name]: {
        type: 'File',
        resolve: (source, _, context) => context.nodeModel.getNodeById({
